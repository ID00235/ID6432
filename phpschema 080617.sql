...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 08, 2017 at 09:17 AM
...
CREATE TABLE `anggota_keluarga` (
  ...
  `hubungan_keluarga` enum('Adik','Anak Angkat','Anak Kandung','Anak Tiri','Ayah','Cucu','Famili lain','Ibu','Istri','Kakak','Kakek','Kepala Keluarga','Keponakan','Menantu','Mertua','Nenek','Paman','Sepupu','Suami','Tante','Teman') NOT NULL,
  `jenis_kelamin` enum('Laki-Laki','Perempuan') NOT NULL,
  `tempat_lahir` varchar(40) NOT NULL,
  `tanggal_lahir` date NOT NULL,
  `tanggal_pencatatan` date NOT NULL,
  `status_kawin` enum('Belum Kawin','Kawin','Janda/Duda') NOT NULL,
  `agama` enum('Islam','Kristen','Hindu','Budha','Katolik','Konghucu','Kepercayaan') NOT NULL,
  `pendidikan` int(11) NOT NULL,
  `pekerjaan` int(11) NOT NULL,
  `cacat_fisik` enum('Tidak Ada','Sumbing','Tuna Netra','Tuna Rungu','Tuna Wicara','Lumpuh') NOT NULL,
  `cacat_mental` enum('Tidak Ada','Gila','Stress','Idiot') NOT NULL,
...
INSERT INTO `anggota_keluarga` (`id`, `id_desa`, `id_kk`, `no_urut`, `nik`, `nama_lengkap`, `no_akte_kelahiran`, `hubungan_keluarga`, `jenis_kelamin`, `tempat_lahir`, `tanggal_lahir`, `tanggal_pencatatan`, `status_kawin`, `agama`, `pendidikan`, `pekerjaan`, `cacat_fisik`, `cacat_mental`, `created_at`, `updated_at`) VALUES
(1, 1, 2, 1, '192356236236347347', 'Ibrahim', '', 'Kepala Keluarga', 'Laki-Laki', 'OLAK', '1966-07-12', '2017-06-06', 'Kawin', 'Islam', 22, 9, 'Tidak Ada', 'Tidak Ada', '2017-06-06 06:54:25', '2017-06-06 07:54:16');
...
(1, '1504052017', '0.00', '0.00', 0, 0.636236, 0, 0, 0, 0, 'desa', '2017-05-30 10:35:59', '2017-06-05 08:11:03');
...
INSERT INTO `kepala_keluarga` (`id`, `id_desa`, `tanggal`, `nomor_kk`, `nama_kepala_keluarga`, `alamat`, `rt`, `rw`, `dusun`, `sumber_data`, `alamat_asal`, `created_at`, `updated_at`) VALUES
(1, 1, '2017-06-13', '1504052009900001', 'ZAINUDIN', 'DESA SENGKATI', '01', '02', 'DUSUN TINGGAL', 'SENSUS', '', '2017-06-05 10:19:24', '2017-06-05 10:29:22'),
(2, 1, '2017-06-14', '1504052009903001', 'IBRAHIM', 'DESA SENGKATI', '01', '02', 'DUSUN TINGGAL', 'SENSUS', '', '2017-06-05 11:16:33', '2017-06-05 11:22:30');
...
--
-- Table structure for table `kesejahteraan_keluarga`
--

CREATE TABLE `kesejahteraan_keluarga` (
  `id` int(11) NOT NULL,
  `id_desa` int(11) NOT NULL,
  `id_kk` int(11) NOT NULL,
  `jumlah_penghasilan` decimal(10,2) NOT NULL,
  `kepemilikan_rumah` enum('Milik Sendiri','Milik Orang Tua','Milik Keluarga','Sewa/Kontrak','Pinjam Pakai') NOT NULL,
  `kategori_keluarga` enum('Pra Sejahtera','Sejahtera 1','Sejahtera 2','Sejahtera 3+') NOT NULL,
  `penerima_raskin` enum('Tidak','Ya') NOT NULL,
  `penerima_blt_blsm` enum('Tidak','Ya') NOT NULL,
  `penerima_bpjs_jamkesmas_jamkesda` enum('Tidak','Ya') NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `kesejahteraan_keluarga`
--

INSERT INTO `kesejahteraan_keluarga` (`id`, `id_desa`, `id_kk`, `jumlah_penghasilan`, `kepemilikan_rumah`, `kategori_keluarga`, `penerima_raskin`, `penerima_blt_blsm`, `penerima_bpjs_jamkesmas_jamkesda`, `created_at`, `updated_at`) VALUES
(1, 1, 1, '3500000.00', 'Milik Sendiri', 'Sejahtera 1', 'Tidak', 'Tidak', 'Tidak', '2017-06-06 09:03:25', '2017-06-06 09:03:25'),
(6, 1, 2, '700000.00', 'Milik Sendiri', 'Pra Sejahtera', 'Ya', 'Ya', 'Ya', '2017-06-06 09:19:50', '2017-06-06 09:20:06');
...
(1, 'Petani', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(2, 'Buruh Tani', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(3, 'Buruh Migran', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(5, 'Pegawai Negeri Sipil', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(7, 'Pengrajin', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(8, 'Pedagang barang kelontong', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(9, 'Peternak', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(10, 'Nelayan', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(11, 'Montir', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(12, 'Dokter swasta', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(13, 'Perawat swasta', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(14, 'Bidan swasta', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(15, 'Ahli Pengobatan Alternatif', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(16, 'TNI', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(17, 'POLRI', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(18, 'Pengusaha kecil  menengah dan besar', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(19, 'Guru swasta', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(20, 'Dosen swasta', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(21, 'Seniman/artis', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(22, 'Pedagang Keliling', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(23, 'Penambang', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(24, 'Tukang Kayu', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(25, 'Tukang Batu', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(26, 'Tukang Cuci', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(27, 'Pembantu rumah tangga', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(28, 'Pengacara', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(29, 'Notaris', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(30, 'Dukun Tradisional', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(31, 'Arsitektur/Desainer', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(32, 'Karyawan Perusahaan Swasta', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(33, 'Karyawan Perusahaan Pemerintah', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(34, 'Wiraswasta', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(35, 'Konsultan Manajemen dan Teknis', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(36, 'Tidak Mempunyai Pekerjaan Tetap', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(37, 'Belum Bekerja', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(38, 'Pelajar', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(39, 'Ibu Rumah Tangga', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(40, 'Purnawirawan/Pensiunan', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(41, 'Perangkat Desa', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(42, 'Buruh Harian Lepas', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(55, 'Pemilik perusahaan', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(56, 'Pengusaha perdagangan hasil bumi', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(57, 'Buruh jasa perdagangan hasil bumi', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(58, 'Pemilik usaha jasa transportasi dan perh', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(59, 'Buruh usaha jasa transportasi dan perhub', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(60, 'Pemilik usaha informasi dan komunikasi', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(61, 'Buruh usaha jasa informasi dan komunikas', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(62, 'Kontraktor', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(63, 'Pemilik usaha jasa hiburan dan pariwisat', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(64, 'Buruh usaha jasa hiburan dan pariwisata', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(65, 'Pemilik usaha hotel dan penginapan lainn', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(66, 'Buruh usaha hotel dan penginapan lainnya', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(67, 'Pemilik usaha warung  rumah makan dan re', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(68, 'Dukun/paranormal/supranatural', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(69, 'Jasa pengobatan alternatif', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(70, 'Sopir', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(71, 'Usaha jasa pengerah tenaga kerja', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(74, 'Jasa penyewaan peralatan pesta', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(75, 'Pemulung', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(76, 'Pengrajin industri rumah tangga lainnya', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(77, 'Tukang Anyaman', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(78, 'Tukang Jahit', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(79, 'Tukang Kue', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(80, 'Tukang Rias', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(81, 'Tukang Sumur', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(82, 'Jasa Konsultansi Manajemen dan Teknis', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(83, 'Juru Masak', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(84, 'Karyawan Honorer', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(85, 'Pialang', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(86, 'Pskiater/Psikolog', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(87, 'Wartawan', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(88, 'Tukang Cukur', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(89, 'Tukang Las', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(90, 'Tukang Gigi', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(91, 'Tukang Listrik', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(92, 'Pemuka Agama', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(93, 'Anggota Legislatif', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(94, 'Kepala Daerah', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(96, 'Apoteker', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(97, 'Presiden', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(98, 'Wakil presiden', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(99, 'Anggota mahkamah konstitusi', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(100, 'Anggota kabinet kementrian', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(101, 'Duta besar', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(102, 'Gubernur', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(103, 'Wakil bupati', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(104, 'Pilot', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(105, 'Penyiar radio', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(106, 'Pelaut', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(107, 'Peneliti', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(108, 'Satpam/Security', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(109, 'Wakil Gubernur', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(110, 'Bupati/walikota', '2017-06-06 12:57:15', '0000-00-00 00:00:00'),
(112, 'Akuntan', '2017-06-06 12:57:15', '0000-00-00 00:00:00');
...
(2, 'Sedang SD/sederajat'),
(3, 'Sedang SLTA/sederajat'),
(4, 'Sedang D-2/sederajat'),
(5, 'Sedang S-1/sederajat'),
(6, 'Sedang S-3/sederajat'),
(7, 'Tamat SLTP/sederajat'),
(8, 'Tamat D-1/sederajat'),
(9, 'Tamat D-3/sederajat'),
(10, 'Tamat S-1/sederajat'),
(11, 'Tamat S-3/sederajat'),
(12, 'Sedang SLB B/sederajat'),
(13, 'Tamat SLB A/sederajat'),
(14, 'Tamat SLB C/sederajat'),
(15, 'Tidak dapat membaca dan menulis huruf La'),
(16, 'Sedang TK/Kelompok Bermain'),
(17, 'Sedang SLTP/Sederajat'),
(18, 'Sedang D-1/sederajat'),
(19, 'Sedang D-3/sederajat'),
(20, 'Sedang S-2/sederajat'),
(21, 'Tamat SD/sederajat'),
(22, 'Tamat SLTA/sederajat'),
(23, 'Tamat D-2/sederajat'),
(24, 'Tamat D-4/sederajat'),
(25, 'Tamat S-2/sederajat'),
(26, 'Sedang SLB A/sederajat'),
(27, 'Sedang SLB C/sederajat'),
(28, 'Tamat SLB B/sederajat'),
(29, 'Tidak pernah sekolah'),
(30, 'Tidak tamat SD/sederajat ');
...
(1, '1504052017', '$2y$10$pbexnW4X.h5AtZG8p7aW1eV8SfXtKjYKkiGGmJqJnpjgiIGxF7Sjm', 1, 'desa', 'Bze0TkcpVWCzFvek3R6ukeqRRHQ81hiSOhXMBc6rw8BbKtZqp3lWqunT10H9', '2017-05-27 11:14:25', '2017-06-06 09:26:58', 'Operator Desa', '');
...
--
-- Indexes for table `kesejahteraan_keluarga`
--
ALTER TABLE `kesejahteraan_keluarga`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id_desa` (`id_desa`,`id_kk`) USING BTREE;
...
ALTER TABLE `kepemilikan_lahan_pangan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `kesejahteraan_keluarga`
--
ALTER TABLE `kesejahteraan_keluarga`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
