    ...
    <div class="offset-sm-2 col-md-8">
        <div class="card">
            ...
            <div class="card-block">
				...
				{{Form::bsText("jumlah_keluarga_petani_tanaman_pangan","$data->jumlah_keluarga_petani_tanaman_pangan",['class'=>'col-12 numerik input-right form-control','required'=>true])}}
