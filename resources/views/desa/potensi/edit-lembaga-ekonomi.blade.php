...
<div class="row">
	...
	<div class="offset-sm-2 col-md-8">
        ...
        {!!Form::open(['url' => URLGroup("potensi/sdm/lembaga-ekonomi/update"), 'name'=>'form-update-lembaga_ekonomi'])!!}
        ...
        {{Form::bsText("jumlah_kegiatan",$data->jumlah_kegiatan,['class'=>'col-12 numerik input-right form-control','required'=>true])}}
...
@section("modal")
  ...
  {!!Form::open(['url' => URLGroup("potensi/sdm/lembaga-ekonomi/delete"), 'name'=>'form-delete-lembaga_ekonomi'])!!}
{{Form::hidden("id",Crypt::encrypt($data->id))}}
{!!Form::close()!!} 
...
<script type="text/javascript">
    $(function(){
        var $validator = $("form[name=form-update-lembaga_ekonomi]").validate({
          ignore:[],
          rules: {
          ...
          if(result){ $("form[name=form-delete-lembaga_ekonomi]").submit();}
          }
          });
          })
    })
