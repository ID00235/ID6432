	...
	<div class="offset-sm-2 col-md-8">
		<div class="card">
			<div class="card-header">
    			Kepemilikan Lahan Perkebunan (Edit Data)
          ...
          {!!Form::open(['url' => URLGroup("potensi/sda/kepemilikan-lahan-kebun/update"), 'name'=>'form-update-kepemilikan_lahan_kebun'])!!}
          ...
          {{Form::bsText("jumlah_keluarga_memiliki_lahan",$data->jumlah_keluarga_memiliki_lahan,['class'=>'col-12 numerik input-right form-control','required'=>true])}}
          {{Form::bsText("jumlah_keluarga_tidak_memiliki_lahan",$data->jumlah_keluarga_tidak_memiliki_lahan,['class'=>'col-12 numerik input-right form-control','required'=>true])}}
          {{Form::bsText("jumlah_keluarga_petani_kebun",$data->jumlah_keluarga_petani_kebun,['class'=>'col-12 numerik input-right form-control','required'=>true])}}
...
@section("modal")
  ...
  {!!Form::open(['url' => URLGroup("potensi/sda/kepemilikan-lahan-kebun/delete"), 'name'=>'form-delete-kepemilikan_lahan_kebun'])!!}
{{Form::hidden("id",Crypt::encrypt($data->id))}}
{!!Form::close()!!} 
...
<script type="text/javascript">
    $(function(){
        var $validator = $("form[name=form-update-kepemilikan_lahan_kebun]").validate({
        ignore:[],
        rules: {
        ...
        if(result){ $("form[name=form-delete-kepemilikan_lahan_kebun]").submit();}
        }
        });
        })
    })
