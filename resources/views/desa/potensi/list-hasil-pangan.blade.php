        ...
        <div class="card">
            ...
            <div class="card-block">
                <table class="table table-striped table-bordered table-sm">
                    ...
                    <?php $no = 1;$tahun = 0;?>
                    @foreach($data as $d)
                             @if($d->tahun!=$tahun) <?php $tahun = $d->tahun;?> <tr><td colspan="13"><b>Set Data Tahun {{$d->tahun}}</b></td></tr> @endif
                             <tr>
                                   <td align="center">
                                            <a href="{{URLGroup("potensi/sda/hasil-pangan/edit")}}/{{Hashids::encode($d->id)}}">Edit</a>
                                   </td>
