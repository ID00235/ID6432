...
<b>{{Form::bsText("luas_tanah_sawah","$data->luas_tanah_sawah",['class'=>'col-5 numerik input-right form-control',])}}</b>
<p><b>Tanah Basah</b></p>
...
<b>{{Form::bsText("luas_tanah_basah","$data->luas_tanah_basah",['class'=>'col-5 doubleinput-right form-control', ])}}</b>
...
<b>{{Form::bsText("luas_tanah_fasilitas_umum","$data->luas_tanah_fasilitas_umum",['class'=>'col-5 doubleinput-right form-control', ])}}</b>
...
<b>{{Form::bsText("luas_tanah_kering","$data->luas_tanah_kering",['class'=>'col-5 doubleinput-right form-control', ])}}</b>

{{Form::bsText("perkebunan_rakyat","$data->perkebunan_rakyat",['class'=>'col-12 doubleinput-right form-control', ])}}
{{Form::bsText("perkebunan_negara","$data->perkebunan_negara",['class'=>'col-12 doubleinput-right form-control', ])}}
{{Form::bsText("perkebunan_swasta","$data->perkebunan_swasta",['class'=>'col-12 doubleinput-right form-control', ])}}
{{Form::bsText("perkebunan_perorangan","$data->perkebunan_perorangan",['class'=>'col-12 doubleinput-right form-control', ])}}
...
<b>{{Form::bsText("hutan_produksi","$data->hutan_produksi",['class'=>'col-5 doubleinput-right form-control', ])}}</b>
<p><b>Tanah Hutan</b></p>
...
<b>{{Form::bsText("hutan_suaka","$data->hutan_suaka",['class'=>'col-5 doubleinput-right form-control', ])}}
</b>
{{Form::bsText("hutan_rakyat","$data->hutan_rakyat",['class'=>'col-5 doubleinput-right form-control', ])}}
<b>{{Form::bsText("luas_tanah_hutan","$data->luas_tanah_hutan",['class'=>'col-5 doubleinput-right form-control', ])}}</b>
