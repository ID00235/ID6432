                  ...
                  <div class="container-menu">
                      <div class="row">
                          <div class="col">
                            ...
                            <a class="dropdown-item" href="{{URLGroup('potensi/sda/ruang-publik')}}">Ruang Publik/Taman <sup style="color: red;">list tidak bisa tampilkan data dari tabel</sup></a>
                            <a class="dropdown-item" href="{{URLGroup('potensi/sda/potensi-wisata')}}">Potensi Wisata <sup style="color:  #1E90FF;">OK</sup></a>
                            <a class="dropdown-item" href="{{URLGroup('potensi/sda/apotik-hidup')}}">Apotik Hidup <sup style="color: red;">list tidak bisa tampilkan data dari tabel</sup></a>
                            <hr>
